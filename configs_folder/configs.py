...
tester_config = {
    ...
    'which_samples_to_load': [1, 2, 8],  # manually select which samples to load (overrides num_tests_for_lowdim).
    'BM_fixed_increment_whole': [1.0, -0.5, -1.2, -0.3, 0.7, 0.2, -0.9, 0.1, 1.7], # Which increments to use for marginal tests
